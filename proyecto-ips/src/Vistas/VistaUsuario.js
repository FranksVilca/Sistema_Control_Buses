...
<div className={style.container}>
            <div className={style.titulo}>
              ...
              <p className={style.subtit}><strong>Crear un Turno Nuevo:</strong> Requiere de los elementos de abajo</p>
              <div className={style.botones}>
            <button className={style.crear} type="submit">Crear Turno</button>
            <button className={style.crear} type="submit">Crear Usuario</button>
            </div>
            </div>
            <div className={style.opcion1}>
                ...
                <div className={style.botones}>
            <button className={style.crear} type="submit">Crear</button>
            <button className={style.gestionar} type="submit">Gestionar</button>
            </div>
            </div>
